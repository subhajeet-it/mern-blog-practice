...
export const { signInStart, signInSuccess, signInFailed, updateInStart, updateInSuccess, updateInFailed,deleteInStart,deleteInSuccess,deleteInFailed } = userSlice.actions;
